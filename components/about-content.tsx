...
function ManifestoHero() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[100vh] grid place-items-center overflow-hidden bg-[#e8e4de]"
    >
...
function OriginStory() {
  ...
  return (
    <section ref={ref} className="relative py-24 md:py-36 bg-[#e8e4de] overflow-hidden">
...
function JourneyTimeline() {
  ...
  return (
    <section ref={ref} className="relative py-28 md:py-36 bg-[#e8e4de] overflow-hidden">
      <div className="px-[calc(12.5vw+0.8rem)]">
        {/* Section header */}
        <div className="mb-16">
          <motion.span
...
function TeamTeaser() {
  ...
  return (
    <section ref={ref} className="relative pt-8 pb-28 bg-[#e8e4de] overflow-hidden">
      <div className="px-[calc(12.5vw+0.8rem)]">
        {/* Section header */}
