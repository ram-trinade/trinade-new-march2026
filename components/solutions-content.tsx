...
function HeroSection() {
  ...
  return (
    <section
      ...
      style={{ background: P.cream, minHeight: 'var(--hero-min-h)' }}
    >
      ...
      <div
        ...
        style={{
          ...
          paddingBottom: 'var(--spacing-rhythm-hero)',
        }}
      >
        <motion.div
    ...
    >
      ...
      >
        <motion.p
          ...
          className="leading-[1.4] tracking-[-0.02em] max-w-[var(--container-narrow)]"
          style={{ fontSize: 'var(--text-h3)', fontWeight: 300, color: P.textOnDark }}
        >
  ...
  return (
    ...
    <div
      ...
      style={{
        ...
        borderRadius: 'var(--radius-fluid-lg)',
        padding: 'var(--spacing-fluid-l)',
        ...gridStyle,
      }}
    >
      ...
      />
      {/* Grain texture overlay — subtle per design spec (was 35% opacity) */}
      <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-[0.05]" style={{ mixBlendMode: 'multiply' }}>
      ...
      <h3
        className="font-medium tracking-[-0.01em] relative z-10 transition-colors duration-500"
        style={{
          color: P.textDark,
          fontSize: isLarge ? 'var(--text-card)' : 'var(--text-lead)',
        }}
      >
        {ind.name}
      </h3>
      ...
      <div className="relative z-10 mt-auto">
        <p
          className="leading-[1.75] transition-colors duration-500"
          style={{
            color: P.textMuted,
...
function IndustriesSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-[var(--spacing-gutter)] flex-1 flex flex-col">
        <div
          className="flex items-end justify-between"
          style={{ marginBottom: 'var(--spacing-fluid-m)' }}
        >
          <div>
            <motion.h2
              ...
              style={{ fontSize: 'var(--text-h2)', fontWeight: 300, color: P.textDark }}
            >
            ...
            <motion.p
              ...
              style={{ color: P.textMuted, fontSize: 'var(--text-body)', marginTop: 'var(--spacing-fluid-xs)' }}
            >
        ...
        >
          ...
          <IndustryCard ind={industries[5]} isLarge={false} />
        </motion.div>
    ...
    >
      ...
      <div className="relative z-10 px-[var(--spacing-gutter)]">
        <motion.h2
          ...
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.7, ease: EASE }}
          className="leading-[1.1] tracking-[-0.025em] text-center"
          style={{
          ...
          {services.map((s, i) => (
            ...
            >
              <button
                ...
                style={{
                  paddingLeft: 'var(--spacing-fluid-l)',
                  paddingRight: 'var(--spacing-fluid-l)',
                  paddingTop: 'var(--spacing-fluid-m)',
                  paddingBottom: 'var(--spacing-fluid-m)',
                }}
              >
                <h3
                  className="font-medium tracking-[-0.01em] transition-colors duration-300"
                  style={{
                    color: expanded === i ? P.textDark : P.textMuted,
              ...
              <AnimatePresence>
                {expanded === i && (
                  ...
                  >
                    ...
                    >
                      <p
                        className="leading-[1.8] max-w-[43.75rem]"
                        style={{
                          color: P.textMuted,
                          fontSize: 'var(--text-body)',
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-[var(--spacing-gutter)]">
        ...
        <div
          className="grid grid-cols-1 md:grid-cols-2 max-w-[var(--container-narrow)]"
          style={{ gap: 'var(--spacing-fluid-m)' }}
        >
          {differentiators.map((d, i) => (
            ...
            >
              ...
              <p
                ...
                style={{ color: P.textMuted, fontSize: 'var(--text-lead)' }}
              >
                {d.desc}
              </p>
            </motion.div>
