...
export const metadata: Metadata = {
  ...
  description: 'How intelligent systems are transforming clinical workflows, enhancing diagnostic accuracy, and creating patient experiences that feel personal â€” without compromising on compliance or data security.',
  ...
  openGraph: {
    ...
    url: '/blog/ai-in-healthcare-from-diagnostics-to-patient-centric-care',
  ...
  twitter: {
    ...
    images: ['/blog/article-1.png'],
  },
  alternates: {
    canonical: '/blog/ai-in-healthcare-from-diagnostics-to-patient-centric-care',
  },
}
