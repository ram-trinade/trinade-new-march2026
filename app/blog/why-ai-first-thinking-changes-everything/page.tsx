...
const SECTIONS = [
  {
    heading: 'The Flaw in AI-Bolted Solutions',
    content: `When a new technology emerges, the instinct is often to bolt it onto existing systems. We saw this with the internet—print magazines simply uploaded their PDFs online. We saw it with mobile—desktop sites shrank but retained clunky, hover-based navigation.\n\nToday, we see it with artificial intelligence. Companies take legacy architectures designed for deterministic workflows and inject predictive algorithms into the edges. They bolt a chatbot onto a rigid database or add an "AI suggestion" button to a rigid CRM. This is what we call "AI-Bolted" architecture, and it frequently leads to fragile, underwhelming systems.`,
  },
  {
    heading: 'What AI-First Actually Means',
    content: `AI-first thinking requires burning the legacy blueprints. It acknowledges that human input is no longer the primary driver of digital workflow; predictive intelligence is.\n\nIn an AI-first system, the core architecture is probabilistic, fluid, and anticipatory. Instead of a database passively waiting for a user query to retrieve a record, an AI-first system pre-computes the likely needs of the user based on behavioral patterns and contextual data streams, presenting the solution before the user formally realizes the problem.`,
  },
  {
    heading: 'The FlyHigh Network Example',
    content: `Consider our expert network, FlyHigh. An AI-bolted approach would be a simple directory where users manually filter experts by tags and keyword searches, to which we might add an "AI keyword matching algorithm."\n\nBy building FlyHigh as an AI-first system from the ground up, we bypass the directory phase entirely. The user provides a narrative description of their unique challenge, and our multi-layered semantic matching engine analyzes the nuance, predicting not just who has the appropriate resume keywords, but whose specific experiential track record directly maps to resolving that specific nuance.`,
  },
  {
    heading: 'Re-engineering the Enterprise',
    content: `Adopting an AI-first mentality requires a cultural revolution within engineering teams. It shifts the focus from "what features can we build to let users do this?" to "what data architectures can we design to let the system do this autonomously?"\n\nAs we deploy solutions across healthcare, legal, finance, and manufacturing, the AI-first methodology is proving to be the only sustainable path to creating software that truly solves problems at scale, elegantly evolving alongside human needs.`,
  },
]
            ...
            <div className="relative z-10 px-6 md:px-12 lg:px-20 xl:px-32">
              <div className="max-w-[760px] mx-auto">
                ...
                <RevealOnScroll>
                  ...
                  >
                    At Trinade, we don't bolt AI onto existing workflows. We rethink the entire solution from an intelligence-first perspective. Here's how that philosophy shapes every product we build, ensuring systemic efficiency instead of superficial add-ons.
                  </p>
                </RevealOnScroll>
                ...
                {SECTIONS.map((section, i) => (
                  <div key={section.heading}>
                    ...
                    {/* Pull quotes */}
                    {i === 1 && (
                      <PullQuote text="In an AI-first system, the core architecture is probabilistic, fluid, and anticipatory. It presents the solution before the user formally realizes the problem." />
                    )}

                    {i === 3 && (
                      <PullQuote text="Adopting an AI-first mentality requires burning legacy blueprints and shifting focus toward autonomous digital workflows." />
                    )}
                ...
                <RevealOnScroll className="mt-20">
                  <div className="flex flex-wrap gap-3">
                    {['AI Ecosystem', 'Innovation', 'Disruption', 'System Architecture', 'Product Strategy'].map(tag => (
                      <span
                        key={tag}
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-[15px] leading-[1.8]" style={{ color: 'rgba(42,34,24,0.5)' }}>
                        The Trinade team represents a collective of structural engineers, AI scientists, and behavioral designers dedicated to shifting the world's most vital industries into intelligence-native operational states.
                      </p>
                    </div>
                  </div>
                </RevealOnScroll>
