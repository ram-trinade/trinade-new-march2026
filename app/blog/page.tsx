          ...
          <span key={i} className="flex items-center">
            ...
            <span
              ...
              style={{
                ...
                marginLeft: 'var(--spacing-fluid-xl)',
                marginRight: 'var(--spacing-fluid-xl)',
              }}
            />
          </span>
        ))}
...
function ArticleCard({
  ...
  return (
    <motion.article
      ...
      animate={isInView ? { opacity: 1, y: 0 } : {}}
      transition={{ duration: 1, delay: Math.min(index * 0.08, 0.5), ease: EASE }}
    ...
    >
      <Link href={`/blog/${article.slug}`} className="block flex-1 flex flex-col">
        ...
        >
          {/* ── TOP: Image ── */}
          <div className="relative overflow-hidden" style={{ height: 'clamp(13.75rem, 22vw, 18.75rem)' }}>
            <motion.div
          ...
          <div className="flex flex-col flex-1 justify-between p-6 md:p-7 relative">
            <div>
              {/* Title */}
              <motion.h3
                className="font-medium leading-[1.2] tracking-tight mb-3"
  ...
  return (
    ...
    >
      ...
      <div className="block cursor-default">
        ...
        >
          <div className="flex flex-col lg:flex-row" style={{ minHeight: 'clamp(25rem, 50svh, 36rem)' }}>
            {/* ── LEFT: Image Column ── */}
            <div className="relative lg:w-[38%] overflow-hidden" style={{ minHeight: 'clamp(17.5rem, 35vw, 26.25rem)' }}>
              <motion.div
                className="absolute inset-0"
            ...
            <div className="lg:w-[62%] flex flex-col justify-between p-5 md:p-10 lg:p-14">
              <div>
                <motion.h2
                  className="font-light tracking-tight leading-[1.1] mb-6"
                  initial={{ opacity: 0, y: 20 }}
                  animate={isInView ? { opacity: 1, y: 0 } : {}}
                  transition={{ duration: 1, delay: 0.5, ease: EASE }}
                  style={{ fontSize: 'var(--text-h2)', color: '#2a2218' }}
                >
                  {article.title}
                </motion.h2>
    ...
    <>
      <div className="solutions-page relative" style={{ background: '#f2ede6' }}>
        ...
        <SmoothScroll>
          {/* ═══════════════ HERO ═══════════════ */}
          <section
            className="relative min-h-[70svh] md:min-h-screen flex flex-col justify-between overflow-hidden"
          ...
          >
            ...
            <div className="relative z-10 flex-1 flex items-center px-6 md:px-12 lg:px-20 xl:px-32 pt-24 md:pt-32">
                  ...
                  <div className="lg:flex-[1]">
                    ...
                    >
                      ...
                      <h1
                        ...
                        style={{ fontSize: 'var(--text-hero-xl)', color: '#2a2218' }}
                      >
                        Blog
                      </h1>
                    </motion.div>
                  ...
                  <div className="lg:flex-[1] pb-4">
                    <RevealOnScroll delay={0.3}>
                      <p
                        ...
                        style={{ fontSize: 'var(--text-lead)', color: 'rgba(42,34,24,0.55)' }}
                      >
