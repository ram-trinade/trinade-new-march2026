...
const SECTIONS = [
  {
    heading: 'The Enterprise Security Paradox',
    content: `As organizations push sensitive workloads to the cloud to leverage massive computing power for AI, they encounter a paradox: AI models require massive troves of interconnected data to be effective, yet exposing that interconnected data creates unprecedented security risks.\n\nEnterprise AI demands more than just patching old security frameworks. It requires zero-trust architectures specifically engineered for dynamic workloads and data flow.`,
  },
  {
  ...
  },
  {
    ...
    content: `Security is not merely defense against hackers; it’s defense against regulatory fines. As GDPR, CCPA, and AI-specific legislation (like the EU AI Act) come into force, tracking data lineage manually is impossible.\n\nWe build automated compliance directly into the data infrastructure. When an AI model generates an output, the system can instantly verify and audit the specific data lineages that contributed to the output, proving compliance in real-time.`,
  },
  {
    heading: 'A Resilient AI Future',
    content: `Securing AI is about more than encryption. It is about adversarial robustness—preventing data poisoning and prompt injection attacks before they compromise the underlying system. The next generation of secure AI infrastructure must actively identify hostile perturbations in input data and neutralize them before inference occurs.\n\nScale without security is a liability. Scale with intelligent security is the foundation of the true AI revolution.`,
  },
]
            ...
            <div className="relative z-10 px-6 md:px-12 lg:px-20 xl:px-32">
              <div className="max-w-[760px] mx-auto">
                ...
                <RevealOnScroll>
                  ...
                  >
                    Enterprise AI demands more than just powerful models. It requires zero-trust architectures, automated compliance, and infrastructure that scales without sacrificing security or governance.
                  </p>
                </RevealOnScroll>
                ...
                {SECTIONS.map((section, i) => (
                  <div key={section.heading}>
                    ...
                    {/* Pull quotes */}
                    {i === 1 && (
                      <PullQuote text="Through federated learning, models train on local data silos without ever extracting the raw data into a centralized vulnerable warehouse." />
                    )}

                    {i === 2 && (
                      <PullQuote text="Scale without security is a liability. Scale with intelligent security is the foundation of the true AI revolution." />
                    )}
                ...
                <RevealOnScroll className="mt-20">
                  <div className="flex flex-wrap gap-3">
                    {['Cloud Security', 'Federated Learning', 'Zero Trust', 'Compliance', 'Data Privacy'].map(tag => (
                      <span
                        key={tag}
