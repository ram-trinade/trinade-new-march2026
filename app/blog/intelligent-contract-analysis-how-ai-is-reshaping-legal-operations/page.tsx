...
const SECTIONS = [
  {
    heading: 'The Shift in Legal Operations',
    content: `For decades, legal document review was viewed as an inescapable manual burden. Associates spent thousands of hours poring over boilerplate contracts, identifying indemnification clauses, and verifying compliance. That era is over.\n\nNow, machine learning models trained on millions of legal corpora are transforming contract analysis. These intelligent systems don't replace lawyers—they surface insights buried deeply in thousands of pages, turning weeks of document review into hours of high-value strategic decision-making.`,
  },
  {
    heading: 'Beyond Simple Keyword Searches',
    content: `Traditional legal software relied heavily on boolean searches. The problem? Legal language is nuanced. If a keyword was misspecified, catastrophic risks were missed.\n\nModern Natural Language Processing (NLP) understands context. It recognizes that "limitation of liability," "liability cap," and "maximum damages" often refer to the same conceptual risk, even if the exact phrasing differs. It highlights inconsistencies across documents, flags anomalous clauses, and generates comprehensible summaries for executive stakeholders without legal background.`,
  },
  {
  ...
  },
  {
    ...
    content: `Intelligent contract analysis is just the first step. We are building toward a proactive compliance layer where AI continuously monitors active contracts against changing regulatory landscapes. When a new privacy law passes, the system instantly highlights all contracts requiring amendments.\n\nAI is reshaping legal operations from a cost center into a strategic advantage, freeing legal minds to focus on negotiation, strategy, and complex problem-solving.`,
  },
]
            ...
            <div className="relative z-10 px-6 md:px-12 lg:px-20 xl:px-32">
              <div className="max-w-[760px] mx-auto">
                ...
                <RevealOnScroll>
                  ...
                  >
                    Law firms and corporate legal departments are turning to intelligent systems to handle massive volumes of document review, transforming what used to be a long manual process into an automated stream of high-level insights.
                  </p>
                </RevealOnScroll>
                ...
                {SECTIONS.map((section, i) => (
                  <div key={section.heading}>
                    ...
                    {/* Pull quotes */}
                    {i === 1 && (
                      <PullQuote text="Intelligent systems do not replace lawyers; they surface insights buried deeply, turning weeks of document review into hours of strategic decision-making." />
                    )}

                    {i === 2 && (
                      <PullQuote text="AI is tirelessly vigilant, converting the tedious burden of document discovery into actionable risk mitigation." />
                    )}
                ...
                <RevealOnScroll className="mt-20">
                  <div className="flex flex-wrap gap-3">
                    {['Legal Tech', 'Contract Analysis', 'Due Diligence', 'Machine Learning', 'Corporate Law', 'Compliance'].map(tag => (
                      <span
                        key={tag}
