...
const SECTIONS = [
  {
    ...
    content: `Walk into any Fortune 500 company, and you will find a graveyard of failed AI pilot programs. They look beautiful in controlled sandbox environments, predicting outcomes with 98% accuracy on perfectly clean dataset snippets. Yet, when deployed to production, these same models degrade, fail to integrate with legacy APIs, and get abandoned by frustrated business users.\n\nWhy? Because engineering a pilot is an isolated data science task. Engineering a production deployment is a cross-functional enterprise transformation.`,
  },
  {
    heading: 'Data Governance Is Not Optional',
    content: `Scalable AI requires scalable data. Most enterprises run into rapid scaling issues because their data pipelines are heavily fragmented. A predictive analytics pilot might use manually exported CSVs; production requires robust, real-time data streaming.\n\nBefore deploying AI across various business units, an organization must establish a unified data layer. This involves clear data lineage, automated quality checks, and robust API orchestration to ingest data seamlessly from disparate enterprise silos into the central model environment.`,
  },
  {
    heading: 'The Cultural Shift of AI Adoption',
    content: `Technical failure is rarely the primary reason AI implementations fail to scale; human rejection is. When frontline employees perceive an AI system as a black-box replacement rather than an augmentation tool, they naturally resist its adoption.\n\nScaling AI effectively requires intense focus on human-in-the-loop interfaces. The AI must explain its reasoning, provide actionable recommendations rather than robotic commands, and comfortably integrate into the user's existing workflow without requiring drastic behavioral changes.`,
  },
  {
    heading: 'Iterating on Imperfect Solutions',
    content: `The pursuit of the perfect model often delays enterprise agility. A model in production that delivers 80% accuracy and actively improves through MLOps feedback loops is infinitely more valuable than a theoretical model trapped in R&D pending 99% accuracy.\n\nBy treating enterprise AI not as a software installation, but as a living system that requires continuous monitoring, retraining, and iteration, companies can escape pilot purgatory and begin realizing true organizational transformation.`,
  },
]
            ...
            <div className="relative z-10 px-6 md:px-12 lg:px-20 xl:px-32">
              <div className="max-w-[760px] mx-auto">
                ...
                <RevealOnScroll>
                  ...
                  >
                    Organizations worldwide are grappling with the chasm between experimental AI and practical deployment. Escaping "pilot purgatory" isn't a technical challenge—it requires executive alignment and fundamental data governance scaling.
                  </p>
                </RevealOnScroll>
                ...
                {SECTIONS.map((section, i) => (
                  <div key={section.heading}>
                    ...
                    {/* Pull quotes */}
                    {i === 1 && (
                      <PullQuote text="Most enterprises run into rapid scaling issues because their data pipelines are heavily fragmented. Scalable AI demands scalable data." />
                    )}

                    {i === 3 && (
                      <PullQuote text="A model in production that actively improves through MLOps feedback loops is infinitely more valuable than a theoretical model trapped in R&D pending 99% accuracy." />
                    )}
                ...
                <RevealOnScroll className="mt-20">
                  <div className="flex flex-wrap gap-3">
                    {['AI Strategy', 'Enterprise Architecture', 'Data Governance', 'MLOps', 'Change Management'].map(tag => (
                      <span
                        key={tag}
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-[15px] leading-[1.8]" style={{ color: 'rgba(42,34,24,0.5)' }}>
                        Rohan integrates enterprise architecture with strategic execution, guiding massive organizations away from isolated AI experiments and into mature, operationalized AI adoption frameworks.
                      </p>
                    </div>
                  </div>
                </RevealOnScroll>
